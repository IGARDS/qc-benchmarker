...
[//]: # (Here we calculate peak capacity as defined in QuiC)

```{r Estimate peak capacity, eval=FALSE, echo=FALSE}

```
\begin{center}Figure 2: Peak capacity.\end{center}
