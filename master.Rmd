...
```{r Import process and write files, echo=FALSE}
...
mzml_dir <- paste(OUTPUT_DIR,'/..',sep='')
mzml_file <- paste(mzml_dir,'/',QUERY,'.mzML',sep='')

# convert query to mzML
print(paste('wine msconvert', paste(OUTPUT_DIR,'/../',QUERY,'.raw',sep=''),'-v --mzML -o',mzml_dir))
#system(paste('wine msconvert', paste(OUTPUT_DIR,'/../',QUERY,'.raw',sep=''),'-v --mzML -o',mzml_dir))
