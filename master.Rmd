...
# determine mass error using experimental m/z versus calculated m/z of identified PSMs

query_psms <- psms(query_ids)
ms1Error_ppm_query <- mean((abs(query_psms[,5]-query_psms[,6])/query_psms[,6])*1000000)

cat('Average MS1 mass error: ', ms1Error_ppm_query, ' ppm.', sep='')
